...
* Localhost: This just needs to be extracted
  ...
  * `Download localhost. <https://github.com/kanors-emr/Veda2.0-Installation/releases/download/v3.0.7.0/Veda2.0_localhost_3.0.7.0.7z>`_
  * Give full read and write permissions to the folder where it is extracted.
  * Open port 65001.
        
* Installer: This is a setup executable

  * `Download installer. <https://github.com/kanors-emr/Veda2.0-Installation/releases/download/v3.0.7.0/Veda2.0.Setup.3.0.7.0.exe>`_
